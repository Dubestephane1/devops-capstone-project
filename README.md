...
![Build Status](https://github.com/Dubestephane1/devops-capstone-project/actions/workflows/ci-build.yaml/badge.svg)

Capstone project for the IBM DevOps and Software Engineering Professional Certificate — a Customer Accounts microservice (Flask REST API) deployed with CI/CD on Kubernetes/OpenShift.
